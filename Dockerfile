...
RUN mkdir -p /tmp/build && \
	...
	cd /tmp/build/libpng-${LIBPNG_VERSION} && \
...
RUN mkdir -p /tmp/build && \
	...
	LD_LIBRARY_PATH=/tmp/build/incubator-pagespeed-ngx-${PAGESPEED_VERSION}-stable/usr/lib:/usr/lib ./configure \
	--sbin-path=/usr/sbin \
...
RUN rm -rf /var/lib/apt/lists/* && rm -rf /tmp/build/* && \
...
# Start the nginx service on container startup
